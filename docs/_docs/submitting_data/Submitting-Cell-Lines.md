...
![Form to create the base record](wiki_images/submitting-data/cell-lines-base-create.png)
...
![Add Cell Type](wiki_images/submitting-data/cell-lines-types-add.png)

A new browser tab will open with the Create Record form.

![Form to create the cell type](wiki_images/submitting-data/cell-lines-types-create.png)
...
![Add Validation asset record](wiki_images/submitting-data/cell-lines-validation-add.png)

A new browser tab will open with the Create Record form (using Pluripotency Validation Asset as an example).

![Create Validation asset record](wiki_images/submitting-data/cell-lines-validation-create.png)
...
![Add vector map record](wiki_images/submitting-data/cell-lines-vector-map-add.png)

A new browser tab opens with the Create Record form.

![Create vector map record](wiki_images/submitting-data/cell-lines-vector-map-create.png)
...
![Create parental cell line record](wiki_images/submitting-data/cell-lines-parental-create.png)
